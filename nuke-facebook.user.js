...
$(document).ready(function () {
    ...
    var body = $('body');
    body.empty();
    var font = '<link href="https://fonts.googleapis.com/css?family=Oxygen+Mono" rel="stylesheet">';
    body.append(font);
    body.append('<div class=\'shut-it-down\'></div>');
    // Embed the gif
    // https://giphy.com/gifs/yyp58Yx3Qk0TK
    var embeddedGif = '<iframe src="https://giphy.com/embed/yyp58Yx3Qk0TK" width="480" height="269" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/yyp58Yx3Qk0TK"></a></p>';
    var shutItDown = $('.shut-it-down');
    shutItDown.append(embeddedGif);
    // https://stackoverflow.com/a/21709814/1478636
    shutItDown.append('<span class="sid-text"></span>');
    var shutItText = $('.sid-text');
